import{f as u,a as h}from"./theme-52e79c04.js";const g=document.querySelector(".bookgallery");document.querySelector(".home-typeBook");const m=async()=>{let i=await u();i=i.map(o=>({...o,books:o.books})),g.innerHTML=await k(i)};m();function k(i){return`
