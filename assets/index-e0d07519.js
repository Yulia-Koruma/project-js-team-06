import{f as u,a as h}from"./theme-4b2f9c37.js";const g=document.querySelector(".bookgallery");document.querySelector(".home-typeBook");const m=async()=>{let i=await u();i=i.map(o=>({...o,books:o.books})),g.innerHTML=await k(i)};m();function k(i){return`
