import{f as u,a as h}from"./theme-99a4ed40.js";const g=document.querySelector(".bookgallery");document.querySelector(".home-typeBook");const m=async()=>{let i=await u();i=i.map(o=>({...o,books:o.books})),g.innerHTML=await k(i)};m();function k(i){return`
