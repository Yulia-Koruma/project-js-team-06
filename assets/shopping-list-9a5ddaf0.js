import{a as E,b as P,c as $,d as x,r as I,g as h,A as r,s as M}from"./support_object-90946e3f.js";function k(s){return s.map(({_id:t,book_image:n,title:o,author:l,list_name:g,description:c,buy_links:d})=>`
...
</li>`).join("")}const y=document.querySelector(".empty-message"),u=document.querySelector(".shopping-list"),B=document.getElementById("firstPage"),b=document.getElementById("prevPage"),w=document.getElementById("currentPage"),C=document.getElementById("nextcurrentPage"),S=document.getElementById("ellipsis"),f=document.getElementById("nextPage"),v=document.getElementById("goToLast"),m=4;let e=1,a;function i(){w.textContent=e,C.textContent=e+1,S.style.display=e<a-1?"block":"none",B.disabled=e===1,b.disabled=e===1,f.disabled=e===a,v.disabled=e===a}function p(){const s=h(r)||[];if(s.length===0)y.style.display="block",u.style.display="none";else{y.style.display="none",u.style.display="block";const t=(e-1)*m,n=t+m,o=s.slice(t,n),l=k(o);u.innerHTML=l}}function q(){const s=h(r)||[];a=Math.ceil(s.length/m)}q();i();B.addEventListener("click",()=>{e!==1&&(e=1,i(),p())});b.addEventListener("click",()=>{e>1&&(e--,i(),p())});f.addEventListener("click",()=>{e<a&&(e++,i(),p())});v.addEventListener("click",()=>{e<a&&(e=a,i(),p())});function L(){const s=document.querySelector(".empty-message"),t=document.querySelector(".shopping-list"),n=h(r)||[];if(n.length===0)s.style.display="block",t.style.display="none";else{s.style.display="none",t.style.display="block";const o=k(n);t.innerHTML=o,t.querySelectorAll(".shop-list-btn").forEach((g,c)=>{g.addEventListener("click",()=>{n[c],n.splice(c,1),M(r,n),L()})})}}document.addEventListener("DOMContentLoaded",()=>{document.querySelectorAll(".button.shop-list-btn").forEach(t=>{t.addEventListener("click",n=>{const o=t.closest(".shop-list-item");if(o){const l=o.getAttribute("data-id");l&&(I(l),o.remove())}})})});L();
